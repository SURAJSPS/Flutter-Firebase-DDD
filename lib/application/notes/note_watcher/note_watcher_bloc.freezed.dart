...
abstract class NotesReceived implements NoteWatcherEvent {
  const factory NotesReceived(
      final Either<NoteFailure, KtList<Note>> failureOrNote) = _$NotesReceived;
...
mixin _$NoteWatcherState {
  ...
  TResult map<TResult extends Object?>({
    ...
    required TResult Function(LoadingInProgress value) loadInProgress,
  ...
  TResult? mapOrNull<TResult extends Object?>({
    ...
    TResult? Function(LoadingInProgress value)? loadInProgress,
...
abstract class _$$LoadingInProgressCopyWith<$Res> {
  factory _$$LoadingInProgressCopyWith(
          _$LoadingInProgress value, $Res Function(_$LoadingInProgress) then) =
      __$$LoadingInProgressCopyWithImpl<$Res>;
}

/// @nodoc
class __$$LoadingInProgressCopyWithImpl<$Res>
    extends _$NoteWatcherStateCopyWithImpl<$Res, _$LoadingInProgress>
    implements _$$LoadingInProgressCopyWith<$Res> {
  __$$LoadingInProgressCopyWithImpl(
      _$LoadingInProgress _value, $Res Function(_$LoadingInProgress) _then)
      : super(_value, _then);
}
...
class _$LoadingInProgress implements LoadingInProgress {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$LoadingInProgress);
  }
...
abstract class LoadingInProgress implements NoteWatcherState {
